...
def main():
    ...
    # device_map= "balanced_low_0" 防止GPU 0内存不足
    ...
    # }
    model = ChatGLMForConditionalGeneration.from_pretrained(
        "chatglm-6b", load_in_8bit=True, trust_remote_code=True,
        device_map="auto", quantization_config=quantization_config
    )

    # model = ChatGLMForConditionalGeneration.from_pretrained(
    #     "chatglm-6b", load_in_8bit=True, trust_remote_code=True, device_map="auto"
    # )
